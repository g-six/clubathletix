export async function getMember(id: string) {
  return (await getMembers()).find((order) => order.id.toString() === id)!
}

export async function getRecentMembers() {
  return (await getMembers()).slice(0, 10)
}
  ...
  return [
    {
      ...
      event: await getTournament('1000'),
    },
    {
      id: 3001,
      url: '/members/3001',
      ...
      event: await getTournament('1001'),
    },
    {
      id: 3002,
      url: '/members/3002',
      ...
      event: await getTournament('1002'),
    },
    {
      id: 3003,
      url: '/members/3003',
    ...
    },
    {
      ...
      event: await getTournament('1003'),
    },
    {
      id: 3005,
      url: '/members/3005',
...
export async function getTournament(id: string) {
  return (await getTournaments()).find((event) => event.id.toString() === id)!
}

export async function getTournamentMembers(id: string) {
  return (await getMembers()).filter((order) => order.event.id.toString() === id)
}
...
export async function getTournaments() {
  return [
    {
      id: 1000,
      name: `Surrey Mayor's Cup`,
      url: '/events/1000',
      date: 'May 20, 2024',
      time: '10 PM',
      location: 'Newton Athletic, Surrey, BC',
    ...
    {
      id: 1003,
      name: 'Surrey FC vs Surrey United FC',
      url: '/events/1003',
      date: 'Dec 31, 2024',
      time: '8 PM',
      location: 'Cloverdale Athletic Park, Surrey, BC',
